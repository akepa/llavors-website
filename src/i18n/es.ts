const es = {
  ...
  res_o1: 'Online (videollamada)',
  res_o2: '30 minutos',
  res_o3: 'Sin compromiso',
  res_inperson_note: '¿Necesitas una cita presencial urgente?',
  res_inperson_link: 'Escríbeme por WhatsApp',
  ...
  faq2_a: 'La primera consulta de valoración dura 30 minutos y se hace online, por videollamada. Las sesiones de seguimiento duran entre 45 minutos y 1 hora, dependiendo de las necesidades del niño y la familia.',
  ...
  blog_listing_sub: 'Artículos de divulgación sobre logopedia, lactancia y desarrollo para familias.',
  blog_read_more: 'Leer el artículo',
  blog_reading_time: 'min de lectura',
  blog_author: 'Àngela Alonso Millet',
  blog_published: 'Publicado el',
  blog_cat_funcions_orals: 'Funciones orales',
  blog_cat_lactancia: 'Lactancia y Alimentación',
  blog_cat_comunicacio: 'Comunicación y Lenguaje',
  blog_back_to_blog: '← Mamá Informada',
  ...
  book_success_text: 'Recibirás un correo con los datos en',
  book_success_online_note: 'Es una cita online: te enviaré el enlace de la videollamada por correo.',
