const ca = {
  ...
  res_inperson_link: 'Escriu-nos per WhatsApp',
  ...
  faq2_a: 'La primera consulta de valoració dura 30 minuts. Les sessions de seguiment duren entre 45 minuts i 1 hora, depenent de les necessitats del xiquet i la família.',
  ...
  book_success_online_note: 'És una cita online: rebràs l\'enllaç de la videotrucada per correu.',
